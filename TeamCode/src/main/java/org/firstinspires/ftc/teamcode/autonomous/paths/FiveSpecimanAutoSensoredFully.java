...
public class FiveSpecimanAutoSensoredFully {
        ...
        public static PathChain path() {
                builder
                        ...
                        .addPath(
                                // Line 8
                                new BezierLine(
                                        new Point(5.000, 22.000, Point.CARTESIAN),
                                        new Point(33.700, 82.000, Point.CARTESIAN)
                                )
                        )
                        .setConstantHeadingInterpolation(Math.toRadians(0))
                        .addPath(
                        ...
                        .addPath(
                                ...
                                new BezierLine(
                                        new Point(5.000, 36.000, Point.CARTESIAN),
                                        new Point(33.700, 81.000, Point.CARTESIAN)
                                )
                        )
                        .setConstantHeadingInterpolation(Math.toRadians(0))
                        .addPath(
                        ...
                        .addPath(
                                ...
                                new BezierLine(
                                        new Point(5.000, 36.000, Point.CARTESIAN),
                                        new Point(33.700, 80.000, Point.CARTESIAN)
                                )
                        )
                        .setConstantHeadingInterpolation(Math.toRadians(0))
                        .addPath(
                        ...
                        .addPath(
                                ...
                                new BezierCurve(
                                        ...
                                        new Point(33.700, 78.000, Point.CARTESIAN)
                                )
                        )
                        .setConstantHeadingInterpolation(Math.toRadians(0))
                        .addPath(
