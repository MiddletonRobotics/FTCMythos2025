...
public class PathFollowerCommand extends CommandBase {
    ...
    public PathFollowerCommand(Follower follower, PathChain path) {
        this.follower = follower;
        this.path = path;
    }

    public PathFollowerCommand(Follower follower, Path path) {
    ...
    public PathFollowerCommand setHoldEnd(boolean holdEnd) {
    ...
    public PathFollowerCommand setSpeed(double speed) {
        this.maxSpeed = speed;
        return this;
    }
