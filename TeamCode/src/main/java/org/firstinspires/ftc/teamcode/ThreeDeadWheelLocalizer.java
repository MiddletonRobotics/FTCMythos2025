...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 2054.9160451000153; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2228.552712990244; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1998.624578881134; // x position of the perpendicular encoder (in tick units)
    }
